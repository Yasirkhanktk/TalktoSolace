import svgPaths from "./svg-jmap5htj3m"
...
function Container() {
  return (
    <div
      className="-translate-y-1/2 absolute h-[143.01px] left-[84px] top-[calc(50%-920px)] w-[544px]"
      data-name="Container"
    />
  )
}
    ...
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Man">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 overflow-hidden">
          <img
            alt=""
            className="absolute h-full left-[-2.22%] max-w-none top-0 w-[104.43%]"
            src={imgMan}
          />
        </div>
        <div className="absolute inset-0 overflow-hidden">
          <img
            alt=""
            className="absolute h-[106.6%] left-0 max-w-none top-[-3.3%] w-full"
            src={imgMan1}
          />
        </div>
      </div>
...
function BgImage() {
  return (
    <div
      className="absolute blur-[4px] content-stretch flex flex-col inset-[-4.97%_-5%_-5.03%_-5%] items-start justify-center opacity-95 overflow-clip"
      data-name="BG Image"
    >
      <Man />
    </div>
...
function Man1() {
  return (
    <div
      className="flex-[1_0_0] min-h-px relative rounded-[5px] w-full"
      data-name="Man"
    >
      <div
        aria-hidden
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[5px]">
          <img
            alt=""
            className="absolute h-full left-[-4.77%] max-w-none top-0 w-[109.53%]"
            src={imgMan}
          />
        </div>
        <div className="absolute inset-0 overflow-hidden rounded-[5px]">
...
function ContentInnerImage() {
  return (
    <div
      className="content-stretch flex flex-col h-[233px] items-start justify-center overflow-clip relative rounded-[5px] shrink-0 w-[392px]"
      data-name="Content → Inner Image"
    >
      <Man1 />
    </div>
  )
...
function Top() {
  return (
    <div
      className="-translate-y-1/2 absolute bg-black content-stretch flex h-[316.4px] items-center justify-center left-0 overflow-clip right-0 rounded-[5px] top-[calc(50%-37.09px)]"
      data-name="Top"
    >
      <BgImage />
      <ContentInnerImage />
...
function Container1() {
  return (
    ...
    >
      <div
        className="[word-break:break-word] bg-clip-text flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[14.445px] text-[transparent] tracking-[-0.6019px] whitespace-nowrap"
        style={{
          backgroundImage:
            "linear-gradient(114.46376911054944deg, rgb(233, 30, 99) 8.4861%, rgb(156, 39, 176) 91.514%)",
        }}
      >
...
function RollNo() {
  return (
    <div
      className="absolute content-stretch flex items-center justify-center left-0 top-[-2px]"
      data-name="Roll No"
    >
      <Text />
    </div>
...
function Title() {
  return (
    <div
      className="-translate-y-1/2 absolute content-stretch flex flex-col items-start left-0 top-[calc(50%-10px)]"
      data-name="Title"
    >
      <Container2 />
    </div>
...
function Category() {
  return (
    <div
      className="-translate-y-1/2 absolute content-stretch flex flex-col items-start left-0 top-[calc(50%+10px)] w-[370px]"
      data-name="Category"
    >
      <Container3 />
    </div>
...
function Container4() {
  return (
    <div
      className="h-[20.636px] relative shrink-0 w-full"
      data-name="Container"
    />
  )
}
...
function Year() {
  return (
    <div
      className="-translate-x-1/2 absolute content-stretch flex flex-col items-start left-[calc(50%+329.46px)] top-0 w-[49.87px]"
      data-name="Year"
    >
      <Container4 />
    </div>
...
function TextYear() {
  return (
    <div
      className="absolute h-[40px] left-[55.64px] overflow-clip top-[-2px] w-[708.787px]"
      data-name="Text+Year"
    >
      <Title />
      <Category />
...
function Bottom() {
  return (
    <div
      className="-translate-y-1/2 absolute h-[41px] left-0 right-0 top-[calc(50%+157.5px)]"
      data-name="Bottom"
    >
      <RollNo />
      <TextYear />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Montserrat:Medium',sans-serif] font-medium justify-center leading-[0] left-[57px] text-[#434343] text-[14.445px] top-[33px] tracking-[-0.6019px] whitespace-nowrap">
        <p className="leading-[19.501px]">
          Some nights, your thoughts are louder than the silence.
        </p>
      </div>
    </div>
  )
...
function Primary() {
  return (
    <div
      className="absolute h-[390px] left-0 overflow-clip right-0 top-[499px]"
      data-name="Primary"
    >
      <Top />
      <Bottom />
...
function Component() {
  return (
    <div className="absolute bottom-0 h-[calc(100%-calc(50%-1096.5px)+0px)] left-[660px] pointer-events-none top-[calc(50%-1096.5px)]">
      <div
        className="-translate-y-1/2 h-[968px] pointer-events-auto sticky top-0 w-[560px]"
        data-name="1"
      >
        <Primary />
...
function ManInBlueBg() {
  return (
    <div
      ...
      data-name="Man in Blue BG"
    >
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 overflow-hidden">
          <img
            alt=""
            className="absolute h-full left-[-0.22%] max-w-none top-0 w-[100.44%]"
            src={imgManInBlueBg}
          />
        </div>
        <div className="absolute inset-0 overflow-hidden">
          <img
            alt=""
            className="absolute h-[106.8%] left-0 max-w-none top-[-3.4%] w-full"
            src={imgManInBlueBg1}
          />
        </div>
      </div>
    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[5px]">
          <img
            alt=""
            className="absolute h-full left-[-2.67%] max-w-none top-0 w-[105.35%]"
            src={imgManInBlueBg}
          />
        </div>
        <div className="absolute inset-0 overflow-hidden rounded-[5px]">
...
function ContentInnerImage1() {
  return (
    <div
      className="content-stretch flex flex-col h-[243px] items-start justify-center overflow-clip relative rounded-[5px] shrink-0 w-[411px]"
      data-name="Content → Inner Image"
    >
      <ManInBlueBg1 />
    </div>
...
function Top1() {
  return (
    <div
      className="bg-black content-stretch flex h-[361.6px] items-center justify-center overflow-clip relative rounded-[5px] shrink-0 w-full"
      data-name="Top"
    >
      <BgImage1 />
      <ContentInnerImage1 />
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(116.16764742705078deg, rgb(233, 30, 99) 8.4861%, rgb(156, 39, 176) 91.514%)",
        }}
      >
...
function Primary1() {
  return (
    <div
      className="content-stretch flex flex-col gap-[17px] items-start justify-center overflow-clip relative shrink-0 w-full"
      data-name="Primary"
    >
      <Top1 />
      <Bottom1 />
...
function Container5() {
  return (
    <div
      className="content-stretch flex flex-col items-start relative shrink-0 w-[640px]"
      data-name="Container"
    >
      <Primary1 />
    </div>
...
function LinkProject() {
  return (
    <div
      className="bg-white content-stretch flex items-center pb-[149.45px] px-[80px] relative shrink-0 w-full"
      data-name="Link - Project"
    >
      <Container5 />
    </div>
  )
...
function Component1() {
  return (
    <div className="absolute h-[calc(100%-calc(50%+266.04px)+0px)] inset-[calc(50%+266.04px)_0_0_0] pointer-events-none">
      <div
        className="-translate-y-1/2 content-stretch flex flex-col items-start justify-center pointer-events-auto sticky top-0"
        data-name="2"
      >
        <LinkProject />
      </div>
...
function WomenOnTheChair() {
  return (
    <div
      className="flex-[1_0_0] min-h-px relative w-full"
      data-name="Women on the Chair"
    >
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 overflow-hidden">
          <img
            alt=""
            className="absolute h-[123.76%] left-0 max-w-none top-[-11.88%] w-full"
            src={imgWomenOnTheChair}
          />
        </div>
        <div className="absolute inset-0 overflow-hidden">
          <img
    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[5px]">
          <img
            alt=""
            className="absolute h-[117.99%] left-0 max-w-none top-[-9%] w-full"
            src={imgWomenOnTheChair}
          />
        </div>
        <div className="absolute inset-0 overflow-hidden rounded-[5px]">
...
function ContentInnerImage2() {
  return (
    <div
      className="content-stretch flex flex-col h-[284px] items-start justify-center overflow-clip relative rounded-[5px] shrink-0 w-[479px]"
      data-name="Content → Inner Image"
    >
      <WomenOnTheChair1 />
    </div>
...
function Top2() {
  return (
    <div
      className="bg-black content-stretch flex h-[406.8px] items-center overflow-clip relative rounded-[5px] shrink-0 w-full"
      data-name="Top"
    >
      <BgImage2 />
      <ContentInnerImage2 />
...
function Primary2() {
  return (
    <div
      className="content-stretch flex flex-col gap-[22px] items-start justify-center overflow-clip relative shrink-0 w-full"
      data-name="Primary"
    >
      <Top2 />
      <Bottom2 />
...
function Container10() {
  return (
    <div
      className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-[720px]"
      data-name="Container"
    >
      <Primary2 />
    </div>
...
function LinkProject1() {
  return (
    <div
      className="-translate-y-1/2 absolute content-stretch flex items-center left-0 pb-[124.72px] px-[40px] right-0 top-1/2"
      data-name="Link - Project"
    >
      <Container10 />
    </div>
...
function Component2() {
  return (
    <div
      className="-translate-y-1/2 absolute bg-white content-stretch flex flex-col items-start justify-center left-0 right-0 top-[calc(50%+246.58px)]"
      data-name="3"
    >
      <Frame2 />
    </div>
    ...
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Athletes">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 overflow-hidden">
          <img
            alt=""
            className="absolute h-full left-[-1.84%] max-w-none top-0 w-[103.68%]"
            src={imgAthletes}
          />
        </div>
        <div className="absolute inset-0 overflow-hidden">
          <img
            alt=""
            className="absolute h-[106.67%] left-0 max-w-none top-[-3.33%] w-full"
            src={imgAthletes1}
          />
        </div>
        <div className="absolute inset-0 overflow-hidden">
    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[5px]">
          <img
            alt=""
            className="absolute h-full left-[-4.37%] max-w-none top-0 w-[108.75%]"
            src={imgAthletes}
          />
        </div>
        <div className="absolute inset-0 overflow-hidden rounded-[5px]">
...
function ContentInnerImage3() {
  return (
    <div
      className="content-stretch flex flex-col h-[324px] items-start justify-center overflow-clip relative rounded-[5px] shrink-0 w-[548px]"
      data-name="Content → Inner Image"
    >
      <Athletes1 />
    </div>
...
function Top3() {
  return (
    <div
      className="bg-black content-stretch flex h-[452px] items-center justify-center overflow-clip relative rounded-[5px] shrink-0 w-full"
      data-name="Top"
    >
      <BgImage3 />
      <ContentInnerImage3 />
...
function Secondary() {
  return (
    <div
      className="bg-white content-stretch flex flex-col gap-[22px] items-start justify-center overflow-clip relative shrink-0 w-full"
      data-name="Secondary"
    >
      <Top3 />
      <Bottom3 />
...
function Container15() {
  return (
    <div
      className="absolute content-stretch flex flex-col items-start left-[74px] top-[-0.38px] w-[800px]"
      data-name="Container"
    >
      <Secondary />
    </div>
...
function Line() {
  return (
    <div
      className="bg-gradient-to-b from-[#57c6ca] h-px relative shrink-0 to-[#9e92f4] via-[#7aaddf] via-[51.923%] w-[418px]"
      data-name="Line"
    />
  )
}
    ...
    <div className="content-stretch flex flex-col gap-[13px] items-start relative shrink-0">
      <div className="[word-break:break-word] flex flex-col font-['Montserrat:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[0px] text-black tracking-[-1.7px] w-[431px]">
        <p className="text-[56px]">
          ...
          <span
            className="[word-break:break-word] bg-clip-text font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[56px] text-[transparent]"
            style={{
              backgroundImage:
...
function LinkDark() {
  return (
    <div
      className="content-stretch flex flex-col gap-[10.01px] items-start justify-center overflow-clip relative shrink-0"
      data-name="Link - Dark"
    >
      <Content />
      <LineAlignStretch />
...
function Container20() {
  return (
    <div
      className="-translate-y-1/2 absolute content-stretch flex flex-col items-start left-0 top-[calc(50%-116px)]"
      data-name="Container"
    >
      <LinkDark />
    </div>
...
function SectionAbout() {
  return (
    <div
      ...
      data-name="SectionAbout"
    >
      <p className="[word-break:break-word] font-['Montserrat:Medium',sans-serif] font-medium leading-[26.25px] relative shrink-0 text-[19.85px] text-black w-[384px]">
...
function SectionAbout1() {
  return (
    <div
      className="absolute content-stretch flex items-center left-0 px-[32px] py-[14px] rounded-[14px] top-[66px] w-[261px]"
      style={{
        backgroundImage:
          "linear-gradient(152.7148668405415deg, rgb(233, 30, 99) 8.4861%, rgb(156, 39, 176) 91.514%)",
      }}
      data-name="SectionAbout"
    >
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[21px] not-italic relative shrink-0 text-[14px] text-white tracking-[0.28px] whitespace-nowrap">
...
function Text5() {
  return (
    <div className="h-[18px] relative shrink-0 w-[142px]" data-name="Text" />
  )
}
...
function SectionAbout2() {
  return (
    <div
      className="absolute content-stretch flex h-[28px] items-center left-0 right-[242px] top-[123px]"
      data-name="SectionAbout"
    >
      <Text5 />
    </div>
...
function Reveal() {
  return (
    <div
      className="absolute h-[204px] left-0 top-[174.01px] w-[384px]"
      data-name="Reveal"
    >
      <SectionAbout />
      <SectionAbout1 />
...
function Component4LinkProject() {
  return (
    <div
      className="-translate-y-1/2 absolute bg-white h-[604px] left-[579px] right-[387px] top-[calc(50%+806.5px)]"
      data-name="4 → Link - Project"
    >
      <Container15 />
      <Frame4 />
    </div>
          ...
          <div className="absolute inset-[-7.1%_0_-5.88%_-0.6%]">
            ...
            >
              <g id="Frame 346">
                ...
                />
                <path
                  d={svgPaths.p3c35d800}
                  id="Vector 60"
                  stroke="url(#paint1_linear_0_4)"
                  strokeLinecap="round"
                  strokeWidth="2.92366"
                />
              </g>
...
function Item() {
  return (
    <div
      className="absolute backdrop-blur-[4px] border border-[#e91e63] border-solid content-stretch flex h-[42px] items-center justify-center left-px px-[12px] py-[6px] rounded-[12px] top-0 w-[99px]"
      style={{
        backgroundImage:
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(138.03893207451017deg, rgb(233, 30, 99) 8.4861%, rgb(156, 39, 176) 91.514%)",
        }}
      >
