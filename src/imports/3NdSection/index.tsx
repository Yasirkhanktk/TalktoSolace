      ...
      <div className="absolute h-0 left-[76px] top-[155px] w-[57px]">
        <div className="absolute inset-[-2.5px_-4.39%]">
          <svg className="block size-full" fill="none" height="5" preserveAspectRatio="none" viewBox="0 0 62 5" width="62">
            <path d="M2.5 2.5H59.5" id="Vector 63" stroke="url(#paint0_linear_0_9)" strokeLinecap="round" strokeWidth="5" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_9" x1="2.5" x2="2.64963" y1="2.81801" y2="5.92225">
...
function Before() {
  return (
    <div className="absolute content-stretch flex inset-[0_383.14px_0_0] items-end justify-end pb-[20px] pr-[20px] rounded-br-[20px]" data-name="Before">
...
function Center() {
  return (
    <div className="-translate-x-1/2 absolute bottom-[-42px] left-[calc(50%-18.64px)] top-[-42px] w-[89px]" data-name="Center">
      <Shadow />
    </div>
  );
}
...
function After() {
  return (
    <div className="absolute content-stretch flex inset-[0_0_0_383.14px] items-end pb-[20px] pl-[20px] rounded-bl-[20px]" data-name="After">
...
function Top() {
  return (
    <div className="absolute h-[90px] left-[50px] right-[50px] top-0" data-name="Top">
      <Before />
      ...
      <div className="absolute h-[86.5px] left-[232px] top-[-3.87px] w-[25px]">
        <div className="absolute inset-[1.2%_3.8%_0.78%_3.39%]">
          <svg className="block size-full" fill="none" height="84.7831" preserveAspectRatio="none" viewBox="0 0 23.2015 84.7831" width="23.2015">
            <path d={svgPaths.p278ee200} fill="url(#paint0_linear_0_11)" id="Vector 68" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_11" x1="-0.848731" x2="24.1513" y1="45.99" y2="45.99">
...
function Content1() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[50px] items-center left-0 right-0 top-[calc(50%+141.93px)]" data-name="Content">
      <Container1 />
      <Top1 />
    </div>
  );
              ...
              <div className="h-[45.926px] relative w-[15.692px]">
                <div className="absolute inset-[-0.63%_-2.21%_-0.29%_-1.19%]">
                  <svg className="block size-full" fill="none" height="46.3466" preserveAspectRatio="none" viewBox="0 0 16.2259 46.3466" width="16.2259">
                    <path d={svgPaths.pf5e4ec0} id="Vector 14" stroke="url(#paint0_linear_0_8)" strokeWidth="0.690611" />
                    <defs>
                      <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_8" x1="0.187243" x2="17.6873" y1="14.8952" y2="17.0715">
                        <stop stopColor="#E91E63" />
                        <stop offset="1" stopColor="#9C27B0" />
                      </linearGradient>
                    </defs>
          ...
          <div className="absolute flex h-[43.317px] items-center justify-center left-[-15.54px] top-[24.9px] w-[43.817px]">
            <div className="-scale-y-100 flex-none rotate-[134.33deg]">
              <div className="h-[45.926px] relative w-[15.692px]">
                <div className="absolute inset-[-0.63%_-2.21%_-0.29%_-1.19%]">
                  <svg className="block size-full" fill="none" height="46.3466" preserveAspectRatio="none" viewBox="0 0 16.2259 46.3466" width="16.2259">
                    <path d={svgPaths.pf5e4ec0} id="Vector 15" stroke="url(#paint0_linear_0_7)" strokeWidth="0.690611" />
                    <defs>
                      <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_7" x1="0.187243" x2="17.6873" y1="14.8952" y2="17.0715">
                        <stop stopColor="#E91E63" />
                        <stop offset="1" stopColor="#9C27B0" />
                      </linearGradient>
                    </defs>
      ...
      <div className="absolute h-[42.908px] left-[-0.75px] top-0 w-[96.354px]">
        <div className="absolute inset-[-0.44%_0_0_-0.2%]">
          <svg className="block size-full" fill="none" height="43.096" preserveAspectRatio="none" viewBox="0 0 96.5426 43.096" width="96.5426">
            <path d={svgPaths.p1314e0ca} id="Vector 45" stroke="url(#paint0_linear_0_6)" strokeWidth="0.376384" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_6" x1="0.188192" x2="96.5426" y1="23.5179" y2="23.5179">
                <stop stopColor="#5BC3CC" />
                <stop offset="0.306997" stopColor="#7EAAE0" />
                <stop offset="1" stopColor="#9896F1" />
              </linearGradient>
          ...
          <div className="h-[42.531px] relative w-[57.21px]">
            <div className="absolute inset-[-0.44%_0_0_-0.33%]">
              <svg className="block size-full" fill="none" height="42.7196" preserveAspectRatio="none" viewBox="0 0 57.3986 42.7196" width="57.3986">
                <path d={svgPaths.p29744080} id="Vector 46" opacity="0.19" stroke="url(#paint0_linear_0_10)" strokeWidth="0.376384" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_10" x1="28.7934" x2="-0.540077" y1="42.7196" y2="5.65556">
          ...
          <div className="absolute flex h-[46.12px] items-center justify-center left-[50.62px] top-[0.07px] w-[16.269px]">
            <div className="flex-none rotate-[-0.72deg]">
              <div className="h-[45.926px] relative w-[15.692px]">
                <div className="absolute inset-[-0.63%_-2.21%_-0.29%_-1.19%]">
                  <svg className="block size-full" fill="none" height="46.3466" preserveAspectRatio="none" viewBox="0 0 16.2259 46.3466" width="16.2259">
                    <path d={svgPaths.pf5e4ec0} id="Vector 14" stroke="url(#paint0_linear_0_4)" strokeWidth="0.690611" />
                    <defs>
                      <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_4" x1="0.187243" x2="17.6873" y1="14.8952" y2="17.0715">
                        <stop stopColor="#E91E63" />
                        <stop offset="1" stopColor="#9C27B0" />
                      </linearGradient>
                    </defs>
  ...
  return (
    <div className="h-[72.642px] relative rounded-[45.09px] shrink-0 w-[303.742px]">
      ...
      <div className="absolute h-[42.908px] left-[-0.75px] top-0 w-[96.354px]">
        <div className="absolute inset-[-0.44%_0_0_-0.2%]">
          <svg className="block size-full" fill="none" height="43.096" preserveAspectRatio="none" viewBox="0 0 96.5426 43.096" width="96.5426">
            <path d={svgPaths.p1314e0ca} id="Vector 45" stroke="url(#paint0_linear_0_5)" strokeWidth="0.376384" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_5" x1="0.188192" x2="96.5426" y1="23.5179" y2="23.5179">
                <stop stopColor="#5BC3CC" />
                <stop offset="0.306997" stopColor="#7EAAE0" />
                <stop offset="1" stopColor="#9896F1" />
              </linearGradient>
