...
export default function JourneySection() {
  ...
  const { activeStep } = useDiscreteStepScroll(3, sectionRef, {
    throttleMs: 650,
  });
  ...
  return (
    <section
      ref={sectionRef}
      id="journey-section"
      className="relative flex h-screen min-h-[720px] w-full items-center justify-center overflow-hidden bg-white px-6"
    >
