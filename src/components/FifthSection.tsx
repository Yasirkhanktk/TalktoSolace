...
export default function FifthSection() {
  ...
  const { activeStep, setStep } = useDiscreteStepScroll(3, containerRef, {
    throttleMs: 650,
  });
  ...
  return (
    <section
      ref={containerRef}
      id="meet-solace-section"
      className="relative flex h-screen min-h-[720px] w-full flex-col items-center justify-center overflow-hidden bg-white px-6"
    >
