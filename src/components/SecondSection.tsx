  ...
  return (
    <motion.div
      ...
      variants={{
        ...
        show: { opacity: 1, scale: 1, rotate: 0, transition: { duration: 0.8, ease: EASE } },
      }}
    >
      <div className="flex h-full w-full rotate-[45.98deg] items-center justify-center">
        <svg viewBox="0 0 35.3771 36.6704" fill="none" className="h-[92%] w-[92%]">
          <path d={svgPaths.peb644f0} fill="url(#sparkle_grad)" stroke="white" strokeWidth="0.795427" />
          <defs>
            <linearGradient id="sparkle_grad" gradientUnits="userSpaceOnUse" x1="0" x2="35.6662" y1="11.6617" y2="24.1853">
      ...
      >
        ...
        <div className="max-w-[760px]">
          ...
          <motion.div
            ...
            variants={{
              ...
              show: { width: 57, opacity: 1, transition: { duration: 0.6, delay: 0.3, ease: EASE } },
            }}
          />
        </div>
        ...
        <div className="w-full max-w-[384px]">
          ...
          <div className="mt-7 flex items-center gap-4">
            <motion.a
              href="#"
              className="inline-flex items-center whitespace-nowrap rounded-[14px] bg-gradient-to-br from-[#e91e63] to-[#9c27b0] px-8 py-[14px] text-[14px] tracking-[0.28px] text-white shadow-[0px_8px_16px_rgba(233,30,99,0.34)]"
