...
const MOMENTS: MomentCardType[] = [
  ...
  },
  {
    ...
    quote:
      "I talk to Solace every morning. It helps me process complex emotions in under five minutes.",
    name: "Marcus V.",
  ...
  },
  {
    ...
    quote:
      "The mood trends showed me patterns I never noticed. It feels like a warm soundboard.",
    name: "Elena R.",
    tag: "Mindful Habit",
  },
  {
    ...
    quote:
      "Solace feels incredibly natural and empathetic — a crucial part of my evening unwind.",
    name: "David C.",
    tag: "Stress Relief",
  },
  {
    ...
    quote:
      "No scheduling, no waiting — just genuine, calming conversation whenever I need it.",
    name: "Priya S.",
    tag: "Instant Access",
  },
  {
    ...
    quote:
      "The privacy means I can say what is really on my mind. I genuinely look forward to it.",
    name: "Alex R.",
    tag: "100% Private",
  },
  {
    ...
    quote:
      "Checking in with Solace before sleep has completely replaced late-night doom-scrolling.",
    name: "Liam T.",
    tag: "Night Routine",
  },
  {
    ...
    quote:
      "The gentle voice tone and thoughtful questions help me slow down when my mind is racing.",
    name: "Chloe M.",
    tag: "Calm Mind",
  },
  {
    ...
    quote:
      "I feel truly understood. It is like having a patient listener in my pocket at all times.",
    name: "Julian K.",
  ...
  },
  {
    ...
    quote:
      "A quiet sanctuary to untangle overwhelming thoughts without having to explain myself.",
    name: "Maya S.",
    tag: "Safe Sanctuary",
  },
]
...
function MomentCardItem({
  ...
  if (index === 0) {
    ...
    input = [Math.max(0, peak - delta), peak, Math.min(1, peak + delta)]
    ...
    <section ref={containerRef} className="relative h-[300vh] bg-white">
      <div className="sticky top-0 flex h-screen w-full flex-col items-center justify-center overflow-hidden">
        ...
        <div className="flex w-full flex-col items-center px-6 text-center">
          <span
            ...
            style={{
              ...
              background:
                "linear-gradient(131deg, rgba(233,30,99,0.08), rgba(156,39,176,0.08))",
              color: "#e91e63",
            }}
          >
            Moments
          ...
          <div
            className="mt-3 h-[4px] w-[48px] rounded-full"
            style={{ background: GRAD }}
          />
        </div>
        ...
        <div className="relative mt-8 w-full overflow-visible py-4">
          <motion.div
            className="flex items-center gap-6 px-[10vw]"
            style={{ x: reduce ? 0 : x }}
          >
            {MOMENTS.map((m, idx) => (
              <MomentCardItem
