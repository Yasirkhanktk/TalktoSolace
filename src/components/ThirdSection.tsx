...
import { useDiscreteStepScroll } from "../hooks/useDiscreteStepScroll";
...
export default function ThirdSection() {
  ...
  const { activeStep: activeIdx, setStep: setActiveIdx } = useDiscreteStepScroll(5, sectionRef, {
    throttleMs: 650,
  });
  ...
  return (
    <section
      ref={sectionRef}
      id="features-section"
      className="relative flex h-screen min-h-[720px] w-full flex-col items-center justify-center overflow-hidden bg-white px-6 py-6"
    >
